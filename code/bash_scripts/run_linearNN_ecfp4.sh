#!/bin/bash
#SBATCH --job-name=full_contrastive         	# Job name
...
JOB_FOLDER="/orcd/home/002/jefferyl/orcd/scratch/ContrastLEMBAS/contrastive_model/results/linearNN"
mkdir -p $JOB_FOLDER

# Run python
cd /orcd/home/002/jefferyl/ContrastLEMBAS/contrastive_model/code

python3 model/run_model.py $JOB_FOLDER
