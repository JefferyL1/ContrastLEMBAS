#!/bin/bash
#SBATCH --job-name=molformer         	# Job name
...
JOB_FOLDER="/orcd/home/002/jefferyl/orcd/scratch/ContrastLEMBAS/contrastive_model/results/linearNN_molformer"
mkdir -p $JOB_FOLDER

# Run python (full)
cd /orcd/home/002/jefferyl/ContrastLEMBAS/contrastive_model/code
DRUG_EMBEDDINGS="/home/jefferyl/ContrastLEMBAS/contrastive_model/data/drug_data/embeddings/smiles_to_molformer.pkl"
python3 model/run_model.py --output_dir $JOB_FOLDER --drug_embeddings $DRUG_EMBEDDINGS

# Create folder and redirect stdoutt and stderr
JOB_FOLDER_LIM="/orcd/home/002/jefferyl/orcd/scratch/ContrastLEMBAS/contrastive_model/results/linearNN_molformer_lim"
...
python3 model/run_model.py --output_dir $JOB_FOLDER_LIM --drug_embeddings $DRUG_EMBEDDINGS
